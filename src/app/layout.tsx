...
export const metadata: Metadata = {
  title: {
    default: "Cat Care Guides",
    template: "%s | Cat Care Guides",
  },
  description:
    "Expert cat care guides, product reviews, and health advice for indoor cats. Trusted by cat owners worldwide.",
  metadataBase: new URL("https://catcareguides.com"),
  openGraph: {
    siteName: "Cat Care Guides",
    type: "website",
    locale: "en_US",
    images: [{ url: "https://catcareguides.com/og-image.jpg", width: 1200, height: 630, alt: "canine-site" }],
  },
};
  ...
  return (
    <html lang="en">
      <body className={`${inter.className} antialiased`}>
        ...
        <Footer />
        <Script
          src="https://www.googletagmanager.com/gtag/js?id=G-C0D8M6XENG"
