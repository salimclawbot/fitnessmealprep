export const metadata = { title: "Affiliate Disclosure", alternates: { canonical: "https://catcareguides.com/affiliate-disclosure" } };
...
export default function AffiliateDisclosurePage() {
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 py-10 space-y-4">
      ...
      <p>
        Cat Care Guides is reader-supported. We may earn a commission when you buy through certain links on this site.
      ...
      <p>Email: <a className="text-cyan-700 underline" href="mailto:editorial@catcareguides.com">editorial@catcareguides.com</a></p>
    </div>
  );
}
