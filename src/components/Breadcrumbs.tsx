...
export function breadcrumbSchema(items: BreadcrumbItem[]) {
  return {
    ...
    "@type": "BreadcrumbList",
    itemListElement: [
      { "@type": "ListItem", position: 1, name: "Home", item: "https://airpurifierguide.vercel.app" },
      ...items.map((item, idx) => ({ "@type": "ListItem", position: idx + 2, name: item.label, item: `https://airpurifierguide.vercel.app${item.url}` })),
    ],
  };
}
